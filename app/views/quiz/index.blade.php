          ...
          <div class="col-md-12 ftco-animate text-center">
            <div class="desc">
              <div class="container justify-content-center">
                @if ($quiz->isEmpty())
                  <h3>MÔN HỌC <h2 style="color: yellow;">{{ $subjectName->name }} </h2> HIỆN TẠI CHƯA ĐƯỢC THÊM BÀI QUIZ, CHÚNG TÔI SẼ THÊM BÀI QUIZ TRONG THỜI GIAN SỚM NHẤT</h3>
                @else
                  <h3>DANH SÁCH QUIZ CỦA MÔN {{ $subjectName->name }}</h3>
                @endif
